...
2. Frontend получает данные пользователя от Telegram, отправляет их на.
3. Backend выдает новый график через.
4. Пользователь делает предположение, отправляется на.
