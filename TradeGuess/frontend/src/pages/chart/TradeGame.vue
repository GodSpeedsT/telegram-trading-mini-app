  ...
  <div class="w-full h-full min-h-screen bg-zinc-950 text-white flex flex-col font-sans select-none overflow-hidden relative pb-[90px]">
    ...
    <div class="fixed bottom-0 left-0 w-full bg-zinc-900/90 backdrop-blur-xl border-t border-white/5 z-40 pb-safe shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
      <div class="flex justify-around items-center h-[70px] px-2">
        ...
        <button class="flex flex-col items-center justify-center gap-1 w-16 h-full relative">
          <div class="absolute top-2 w-10 h-10 bg-purple-500/20 rounded-full blur-lg"></div>
