...
<template>
  <nav class="fixed bottom-0 left-0 right-0 z-50">
    <div
      class="absolute inset-0 bg-zinc-900/95 backdrop-blur-xl border-t border-zinc-800/50 shadow-[0_-20px_80px_-12px_rgba(0,0,0,0.9)]"/>
    ...
    <div
      class="absolute -top-2 h-16 w-16 rounded-full blur-xl opacity-30 transition-all duration-700"
